(function () {
  var articles = [
    ...
    { title: "자녀장려금 2026 일정", url: "/child-tax-2026.html", keywords: "자녀장려금 2026 신청" },
    { title: "근로장려금 환수 대처", url: "/earned-income-repayment.html", keywords: "근로장려금 환수 오지급" },
    ...
    { title: "청년내일저축 자격", url: "/youth-savings-eligibility.html", keywords: "청년내일저축계좌 소득 연령 자격" },
    ...
    { title: "실업급여 재취업 조기취업수당", url: "/unemployment-early-reemploy.html", keywords: "실업급여 재취업 조기취업수당" },
    { title: "국가장학금 신청방법", url: "/national-scholarship.html", keywords: "국가장학금 장학금" },
    { title: "국가장학금 감액 탈락", url: "/national-scholarship-cut.html", keywords: "국가장학금 감액 탈락 성적" },
    ...
    { title: "차상위계층 신청 방법", url: "/near-poor-application.html", keywords: "차상위 신청 서류" },
    { title: "기초수급 vs 차상위", url: "/basic-livelihood-vs-near-poor.html", keywords: "기초수급 차상위 차이" },
    { title: "주거급여 탈락", url: "/housing-benefit-rejection.html", keywords: "주거급여 탈락 재신청" },
    { title: "자가 주거급여 수선유지", url: "/housing-benefit-owner.html", keywords: "자가 주거급여 수선유지급여" },
    ...
    { title: "장애인연금 vs 장애수당", url: "/disability-pension-vs-allowance.html", keywords: "장애인연금 장애수당 차이" },
    { title: "통신비 감면", url: "/telecom-discount.html", keywords: "통신비 감면 휴대폰" },
    { title: "통신비 감면 서류", url: "/telecom-discount-documents.html", keywords: "통신비 감면 서류 신청처" },
    { title: "전기요금 할인", url: "/electricity-discount.html", keywords: "전기요금 할인" },
    { title: "전기요금 할인 서류", url: "/electricity-discount-documents.html", keywords: "전기요금 복지할인 서류" },
    ...
    { title: "기초연금 재신청 시기", url: "/basic-pension-reapply-timing.html", keywords: "기초연금 재신청 시기 소득 재산 변동" },
    ...
    { title: "국민연금 공백 추후납부", url: "/national-pension-gap.html", keywords: "국민연금 공백 추후납부" },
    { title: "국민연금 반환일시금", url: "/national-pension-lump-sum.html", keywords: "국민연금 반환일시금 일시금" },
    { title: "퇴직연금 조회방법", url: "/retirement-pension.html", keywords: "퇴직연금" },
    { title: "퇴직연금 중도인출", url: "/retirement-pension-withdrawal.html", keywords: "퇴직연금 중도인출" },
    ...
    { title: "장기요양 등급 변경", url: "/longterm-care-grade-change.html", keywords: "장기요양 등급 갱신 변경" },
    ...
    { title: "건보료 경감 분할납부", url: "/health-premium-reduction.html", keywords: "건강보험료 경감 분할납부 체납" },
    { title: "국가건강검진 대상자", url: "/medical-checkup.html", keywords: "건강검진" },
    { title: "건강검진 놓쳤을 때", url: "/medical-checkup-missed.html", keywords: "건강검진 재검진 놓침" },
    { title: "국가암검진 대상자", url: "/cancer-screening.html", keywords: "암검진" },
    { title: "암검진 놓쳤을 때", url: "/cancer-screening-missed.html", keywords: "암검진 놓침 기간" },
